...
This is the entry point for agents creating or changing pipelines with generic-ci 0.3.0. It describes implemented interfaces. The older product proposals and scenario audits are design history; do not infer support from those documents.
...
Those schemas describe delivery/platform configuration. Source manifest/project schemas are bundled separately. Schema format version 1 is not toolkit version 0.3.0 or an organization source tag such as v1.4.0.
