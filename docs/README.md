...
| Need | Start here |
|---|---|
| Ask an AI to create/edit a pipeline | [AI-assisted authoring — revision three](ai-authoring.md) |
...
| Configure organization templates/defaults once | [Configuration sources — revision two](configuration-sources.md) |
| Define checks, monorepos, versions, packages and deployments | [Implemented workflows — revision one](workflows.md) |
...
Historical developer-experience proposals, product-contracts documents and scenario audits are kept in [archive](archive/) and describe earlier design/review stages. Consult current implementation guides and installed schemas before applying their YAML. They are not evidence that every proposed feature is implemented or production-tested.
...
For existing consumers, start with [0.4 migration](migration-0.4.md). Current guides use stable filenames; revision-named files redirect here for existing links.
