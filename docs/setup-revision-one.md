...
generic-ci setup --yes --mode standalone --app api --path . \
  ...
  --runtime-image registry.internal/ci/python-toolkit:0.3.4 \
  --builder-image registry.internal/ci/buildah-toolkit:0.3.4 \
...
```sh
--deploy yes --helm-image registry.internal/ci/helm-toolkit:0.3.4 \
